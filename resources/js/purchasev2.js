...
$(document).ready(function () {
    ...
    $("#form_telefono,#form_fact_cp,#form_envio_cp,#form_pago_card_tarjeta").keypress(function (e) {
...
const verificar_campos = () => {
    //console.log("Verificar campos formulario");
    let everything_filled = true;
    $(".form-required").each(function () {
        ...
        if (elem_val == "") {
            $(this).parent().find(".invalid-feedback").text("Campo obligatorio");
            $(this).addClass('is-invalid');
            everything_filled = false;
        } else {
            if ($(this).attr("id") == 'form_mail') {
                valid_emailformat = /\S+@\S+/.test($(this).val());
                if (!valid_emailformat) {
                    $("#invalid-mail").text("Formato incorrecto de correo.");
                    $(this).addClass('is-invalid');
                    everything_filled = false;
                } else {
                    $(this).removeClass('is-invalid');
                }
            } else if ($(this).attr("id") == 'form_mail_confirm') {
                valid_emailformat = /\S+@\S+/.test($(this).val());
                if (!valid_emailformat) {
                    $("#invalid-mail-confirm").text("Formato incorrecto de correo.");
                    $(this).addClass('is-invalid');
                    everything_filled = false;
                } else {
                    $(this).removeClass('is-invalid');
...
const set_spinner_atPayment = (toshow) => {
    ...
    $(".payment-proceed").prop("disabled", true)
    $(".payment-proceed").append('&nbsp;&nbsp; <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> <span class="sr-only">Loading...</span>');
    $(".payment-proceed").removeClass("btn-comprar").addClass("btn-comprar-unabled");
}
