        ...
        <div class="col-md-9">
            ...
            <div class="area-box-tpl  mb-5">
                ...
                <div class="all_zone_extraprods d-none">
                    <div class="d-none necesario_compra pt-4 pb-4">Productos necesarios en tu compra para el área: {{$area['area']}} </div>

                    <div class="row sub_header_area mr-md-3 justify-content-center align-items-center d-none">
                        <div class="col-6 col-sm-4 col-md-4 zone mt-2 mb-2 pt-1 pb-1 ">Producto</div>
                        <div class="d-none d-md-block col-4 col-sm-3 col-md-3 zone mt-2 mb-2 pt-1 pb-1 ">Cantidad</div>
                        <div class="d-block d-md-none col-2 col-sm-3 zone mt-2 mb-2 pt-1 pb-1 ">Ventana</div>
                        <div class="d-none d-sm-block col-sm-3 col-md-3 zone mt-2 mb-2 pt-1 pb-1 ">Imágenes</div>
                ...
                <div class="productos_distintos pt-4 pb-3 d-none"> Algunos de sus productos son distintos para cada una de las ventanas del Area: {{$area['area']}} </div>
            </div>
            @endforeach
            <!-- FIN DE BOX TEMPLATE -->
        ...
        <div class="col-md-3 ">
            <div class="column_total pt-4 pb-3 ">
                ...
                <div class="text-center pt-3">
                    ...
                    <button type="button" class="btn-comprar pt-2 pb-2 to_payment_btn">
                        COMPRAR
                    </button>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body mt-2">
                        Está usted comprando productos para el departamento {{$num_depto}}, de la torre {{$nombre_torre}}. ¿Seguro que desea
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-9 text-subtotal pb-4">{{$zone['zone']}}</div>
                            <div class="col-3 text-subtotal pb-3"><span class="text-soft-gray">Producto</span></div>
                            <div class="col-9 text-subtotal pb-4 product_mobarea_text"> <span id="text-a{{$key_a}}-z{{$key_z}}"> ... </span> </div>
                            ...
                            <div class="col-md-12 text-center mt-4">
                                <button class="mw-100 btn_continue pt-1 pb-1 mt-1 mb-1 show-p btn_cont-dis btn-mob-img" data-toggle="modal" href="#carouselModal">
                                    Más..
                                </button>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-9 text-subtotal pb-3">{{$area['style']}}</div>
                            <div class="col-3 text-subtotal pb-3"><span class="text-soft-gray">Ventana</span></div>
                            <div class="col-9 text-subtotal pb-3">{{$zone['zone']}}</div>
                            <div class="col-3 text-subtotal pb-3"><span class="text-soft-gray">Cantidad</span></div>
                            <div class="col-9 text-subtotal pb-4"> <span id="text-a{{$key_a}}-ex{{$key_e}}"> </span> </div>
                            ...
                            <div class="col-md-12 text-center mt-4">
                                <button class="mw-100 btn_continue pt-1 pb-1 mt-1 mb-1 btn-mob-img">
                                    Más..
                                </button>
                            </div>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="row mt-4">
                            <div class="col-3 text-subtotal pb-3"><span class="text-soft-gray">Cantidad</span></div>
                            <div class="col-9 text-subtotal pb-4"> <span id="text-oth{{$key_ex}}"> </span> </div>
